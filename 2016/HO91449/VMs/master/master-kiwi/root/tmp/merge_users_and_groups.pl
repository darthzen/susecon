...
['bin:x:1:1:bin:/bin:/bin/bash', 'bin:*:16983::::::'],
['daemon:x:2:2:Daemon:/sbin:/bin/bash', 'daemon:*:16983::::::'],
['ftp:x:40:49:FTP account:/srv/ftp:/bin/bash', 'ftp:*:16983::::::'],
['games:x:12:100:Games account:/var/games:/bin/bash', 'games:*:16983::::::'],
['lp:x:4:7:Printing daemon:/var/spool/lpd:/bin/bash', 'lp:*:16983::::::'],
['mail:x:8:12:Mailer daemon:/var/spool/clientmqueue:/bin/false', 'mail:*:16983::::::'],
['man:x:13:62:Manual pages viewer:/var/cache/man:/bin/bash', 'man:*:16983::::::'],
['messagebus:x:499:498:User for D-Bus:/var/run/dbus:/bin/false', 'messagebus:!:16983::::::'],
['news:x:9:13:News system:/etc/news:/bin/bash', 'news:*:16983::::::'],
['nobody:x:65534:65533:nobody:/var/lib/nobody:/bin/bash', 'nobody:*:16983::::::'],
['root:x:0:0:root:/root:/bin/bash', 'root:$6$8zI4yBWa$2G1/hnr.n2FupKOM7ZLpoueG2gsxGwW0OXnuxif6BZAmxceqOXn1MZaOPeLNhqSPL4AMehX3BFbsU6SkHYfvC0:17114::::::'],
['salt:x:497:495:salt-master daemon:/var/lib/salt:/bin/false', 'salt:!:16983::::::'],
['sshd:x:498:496:SSH daemon:/var/lib/sshd:/bin/false', 'sshd:!:16983::::::'],
['svn:x:496:494:user for Apache Subversion svnserve:/srv/svn:/sbin/nologin', 'svn:!:17114::::::'],
['uucp:x:10:14:Unix-to-Unix CoPy system:/etc/uucp:/bin/bash', 'uucp:*:16983::::::'],
['wwwrun:x:30:8:WWW daemon apache:/var/lib/wwwrun:/bin/false', 'wwwrun:*:16983::::::']
);
